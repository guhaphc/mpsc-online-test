...
export default function AdminTestsPage() {
  ...
  const generatorTopics = useMemo(() => {
    const childTopics = items.filter(
      (item) =>
        item.paper_id === selectedPaperId &&
    ...
    // Some Mains syllabus subjects do not have separately stored child
    // topics. In that case, allow the whole subject to be used as the
    // syllabus area instead of leaving the Topic dropdown empty.
