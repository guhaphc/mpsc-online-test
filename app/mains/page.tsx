  ...
  return (
    <>
      <style jsx global>{`
        ...
        .mains-upload-preview-footer span { min-width: 0; }
        .mains-upload-preview-footer button {
          min-width: 0;
        ...
        .mains-upload-preview-footer button:last-child {
          color: #a33a3a;
          border-color: #efcaca;
          background: #fff8f8;
        }
                          ...
                          <div className="mains-order-list">
                            {handwrittenFiles.map((file, index) => (
                              <div className="mains-order-row" key={`order-${file.name}-${index}`}>
                                ...
                                <button type="button" className="secondary mains-order-button mains-remove-order-button" onClick={() => removeHandwrittenFile(index)} disabled={uploadingHandwritten}>Remove</button>
                              </div>
                            ))}
                          </div>
                        </div>
