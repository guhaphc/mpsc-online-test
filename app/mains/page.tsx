...
export default function MainsAnswerPage() {
  ...
  async function submitHandwrittenAnswer() {
    ...
    try {
      ...
      setHandwrittenFiles([]);
      setSuccess(`${handwrittenFiles.length} handwritten page/file${handwrittenFiles.length === 1 ? "" : "s"} submitted successfully.`);
    } catch (e) {
                ...
                <>
                  ...
                  <div className="mains-upload-card">
                    ...
                    <button
                      ...
                      type="button"
                      disabled={uploadingHandwritten || handwrittenFiles.length === 0}
                      onClick={submitHandwrittenAnswer}
                    >
                      {uploadingHandwritten ? "Uploading..." : "Submit Handwritten Answer"}
                    </button>
                  </div>
