...
export default function StudyMaterialSubjectPage(){
 ...
 return <main className={"page "+(nightMode?"night-page":"")}><section className={"card study-shell "+(nightMode?"night-mode":"")} style={{"--note-scale":fontScale/100} as React.CSSProperties}>
